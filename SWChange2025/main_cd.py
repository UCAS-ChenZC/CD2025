...
if __name__ == '__main__':
    ...
    parser.add_argument('--project_name', default='levir0209_trainval_256128_Bitch256_E400(0)', type=str)
    ...
    #parser.add_argument('--pretrain', default='pretrain/best_ckpt.pt', type=str)
    ...
    parser.add_argument('--net_G', default='SwinChangeFormerV2', type=str,
